...
export function TeamRow({
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-2xl flex-shrink-0">{flag || '🏳️'}</span>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex justify-between mt-1">
            <span className="text-[10px] text-gray-400 font-mono">{code}1–{code}{STICKERS_PER_TEAM}</span>
      ...
      {isOpen && (
        <div className="px-3 pb-3 border-t border-gray-100">
          ...
          <div className="flex gap-2 mt-2">
            <button
              onClick={onMarkAll}
              className="flex-1 py-1.5 rounded-lg text-xs font-bold text-white transition-colors hover:opacity-90"
            ...
            <button
              onClick={onClearAll}
              className="flex-1 py-1.5 rounded-lg text-xs font-bold text-gray-500 bg-gray-100 hover:bg-gray-200 transition-colors"
            >
              ✗ Limpiar
            </button>
          </div>
